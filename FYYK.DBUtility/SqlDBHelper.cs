...
namespace FYYK.DBUtility
{
    public class SqlDbHelper
    {
        ...
        /// </summary>  
        public static readonly string connectionString = string.Format("Server ={0},{1}; DataBase={2};User ID = {3}; Password={4};Persist Security Info=True;MultipleActiveResultSets=true;Application Name = FYYK.打印Demo;", _Server, _Port, _DataBase, _UserName, _UserPassword);
        #endregion
